...
/**
 * Ограничение на создание сессий с одного адреса. Это защита от обстрела, а не
 * от повторной игры: весь зал часто сидит на одном Wi-Fi, поэтому порог высокий.
 */
const creationLimiter = createRateLimiter({ limit: 60, windowMs: 60 * 60 * 1000 });
